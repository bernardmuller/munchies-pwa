...
const Container = styled.div`
    ...
    border-radius: 1rem;
    padding: 1rem;
    background-image: linear-gradient(0deg, rgb(0, 0, 0, 0.8), rgb(255, 255, 255, 0));
    box-shadow: ${props => props.active ? "rgba(104, 191, 80, 0.50) 0px 5px 15px" : "rgba(0, 0, 0, 0.24) 0px 3px 8px;"};
